...
if(isset($_POST['enviar'])){
    ...
    $precio=($_POST['precio']);
    $cant_total=($_POST['pagtotal']);
$consulta="INSERT INTO ganancias (fecha,litros,empresa,precio,pagtotal) VALUES ('$date', '$litros_vend', '$empresa', '$precio', '$cant_total')";
$resultado=mysqli_query($conex, $consulta);
if($resultado){
    ?>
    <body background="atar.jpg" style="background-size: cover">
    <header class="header">
    <form action="mostrarganancias.php" method="POST">
